    ...
    return (
      ...
      >
        ...
        <p style={style.lineHeight}>
          如果你喜欢我们的工具，欢迎关注
          <a rel="noopener noreferrer" target="_blank" href="https://github.com/dongyubin/wechat-md">
            &nbsp;GitHub&nbsp;
          </a>
          ，右下角关注公众号，查看更多精彩内容，愿意
        ...
        <div style={{display: "flex", alignItems: "center"}}>
          <img
            ...
            src="https://chengxuxiaohei.cn/images/wechatpay.png"
          />
          <img
            alt="图片描述"
            style={style.imgWidth}
            src="https://chengxuxiaohei.cn/uploads/wwgzh.png"
          />
        </div>
      </Modal>
    );
